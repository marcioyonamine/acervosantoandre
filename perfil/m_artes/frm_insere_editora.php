...
?>
	  	...
	  	<div class="container">
            ...
            <p>Digite o nome da gravadora</p>
				...
				<form class="form-horizontal" role="form" action="?perfil=discoteca&p=frm_insere_editora&pag=resultado" method="post">
...
$termo = $_POST['busca'];
$con = bancoMysqli();
$busca = "SELECT * FROM acervo_termo WHERE termo LIKE '%$termo%' AND tipo = '100' ORDER BY termo ASC";
